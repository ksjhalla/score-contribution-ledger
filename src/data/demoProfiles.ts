...
export const demoProfiles: Record<DemoKey, DemoProfile> = {
  ...
  agri: {
    ...
    contributor: {
      name: "Aisha Ng'etich",
      role: "Smallholder Farmer · Specialty Coffee Producer",
      org: "Kaptumo Cooperative Society Ltd. · Nandi County, Kenya",
      id: "SCR-AN-2021-001",
      sector: "Agriculture",
    },
    stats: { settled: 186000, pending: 76000, future: 5000, currency: "KES", contracts: 2, executions: 5 },
    contracts: [
      {
        name: "Kaptumo Cooperative Premium Pool · Season 2024",
        counterparty: "Kaptumo Farmers Cooperative Society Ltd.",
        stake_type: "Financial",
        entitlement:
          "8% of cooperative premium pool above the NCE floor price (KES 120/kg), proportional to delivery weight × quality grade. Linear decay 15%/yr from first delivery, 3% floor, buyout available at 4× cumulative earnings.",
        trigger: "Nairobi Coffee Exchange (NCE) public auction price ≥ KES 120.00/kg for AA-grade lot",
        status: "Active",
      },
      {
        name: "Anaerobic Fermentation Technique · Derivative Licence Agreement",
        counterparty: "Kabitet + Cheptebo Cooperative Society (2 licensees)",
        stake_type: "Attribution",
        entitlement:
          "3% of each adopting cooperative's premium pool above NCE floor, per derivative licence. Linear decay 20%/yr from licence execution date. Capped at KES 5,000 per derivative per season.",
        trigger: "Licence execution event + adopter cooperative's own NCE settlement confirmed",
        status: "Active",
      },
    ],
    executions: [
      {
        title: "Main crop delivery · Lot KMT-2024-007",
        status: "Pending",
        amount: 62000,
        currency: "KES",
        date: "2024-03-14",
        proof: "QR scan · 2,780 kg · 100% ripe cherry · sha256: a3f2c9d1… · RFC 3161 · NCE Week 18 KES 142.40/kg",
        confidence: "High",
        resolver_description: "Nairobi Coffee Exchange (public auction) + Kaptumo cooperative M-PESA transfer",
        expected_resolution: "30 days",
      },
      {
        title: "Fermentation technique · Cheptebo licence · Season 2024",
        status: "Pending",
        amount: 13800,
        currency: "KES",
        date: "2024-02-22",
        proof: "Derivative record sha256: 8c2e5b… linked to origin 9b4e2a1c… · licence executed",
        confidence: "Medium",
        resolver_description: "Cheptebo Cooperative NCE settlement (pending this season)",
        expected_resolution: "90 days",
      },
      {
        title: "Fermentation technique · Kabitet licence · Season 2023",
        status: "Settled",
        amount: 14200,
        currency: "KES",
        date: "2023-04-14",
        proof: "Derivative record sha256: 4f7a1c… linked to origin 9b4e2a1c… · M-PESA settled",
        confidence: "High",
        resolver_description: "Kabitet Cooperative · licence execution + NCE settlement",
        expected_resolution: "Resolved",
      },
      {
        title: "Main crop delivery · Lot KMT-2023-019",
        status: "Settled",
        amount: 68000,
        currency: "KES",
        date: "2023-03-11",
        proof: "QR scan · 2,440 kg · 98% ripe cherry · sha256: 7d1e4af2… · NCE Week 16 KES 138.20/kg · M-PESA confirmed",
        confidence: "High",
        resolver_description: "Nairobi Coffee Exchange + Kaptumo cooperative",
        expected_resolution: "Resolved",
      },
      {
        title: "Main crop delivery · Lot KMT-2022-011",
        status: "Settled",
        amount: 58000,
        currency: "KES",
        date: "2022-03-08",
        proof: "QR scan · 2,210 kg · 97% ripe cherry · sha256: 2c8b5fe1… · NCE Week 15 KES 132.80/kg · M-PESA confirmed",
        confidence: "High",
        resolver_description: "Nairobi Coffee Exchange + Kaptumo cooperative",
        expected_resolution: "Resolved",
      },
    ...
    whatChanged: [
      {
        amount: 62000, currency: "KES",
        headline: "Season 2024 premium pending settlement",
        subheadline: "NCE auction Week 18 confirmed AA-grade premium of KES 22.40/kg above floor. Awaiting cooperative M-PESA transfer.",
        status: "Under review", confidence: "High",
        trigger: "NCE KES 142.40/kg > floor KES 120/kg",
        resolver: "Nairobi Coffee Exchange · public auction",
        expected_resolution: "30 days", evidence_count: 2,
        confirmations: [
          { name: "Kaptumo Mill Operator", org: "Weight + grade confirmation", status: "Confirmed" },
          { name: "CRE Grader", org: "Lot KMT-2024-007", status: "Confirmed" },
          { name: "Cooperative Manager", org: "Post-settlement sign-off", status: "Pending" },
        ],
        proofPack: {
          why_recorded: "NCE Week 18 auction confirmed KES 142.40/kg for Kaptumo AA-grade lot — KES 22.40/kg above the cooperative's floor threshold.",
          evidence_items: [
            "QR-scanned delivery record (SHA-256 + RFC 3161 timestamp)",
            "CRE grading result — AA",
            "Nairobi Coffee Exchange public auction result",
          ],
          verifier: "Nairobi Coffee Exchange (public, independent of cooperative)",
          source: "nce.co.ke",
          confidence_level: "High",
          last_verified_date: "May 2024",
          status: "Awaiting verification",
        },
      },
      {
        amount: 14200, currency: "KES",
        headline: "Kabitet licence royalty received",
        subheadline: "Kabitet Cooperative adopted the fermentation technique under licence. First derivative settlement confirmed.",
        status: "Resolved", confidence: "High",
        trigger: "Licence execution · Kabitet Cooperative",
        resolver: "M-PESA settlement",
        expected_resolution: "Resolved", evidence_count: 2,
        confirmations: [
          { name: "Kabitet Cooperative Society", org: "Licensee", status: "Confirmed" },
          { name: "Aisha Ng'etich", org: "Origin IP holder", status: "Confirmed" },
        ],
        proofPack: {
          why_recorded: "Kabitet Cooperative executed a derivative licence for Aisha's anaerobic fermentation technique and settled the first season's royalty.",
          evidence_items: [
            "Derivative licence record linked to origin IP asset hash",
            "Kabitet NCE AA-grade settlement confirmation",
          ],
          verifier: "Kabitet Cooperative Society",
          source: "Derivative Licence Agreement",
          confidence_level: "High",
          last_verified_date: "Apr 2023",
          status: "Verified",
        },
      },
      {
        amount: 13800, currency: "KES",
        headline: "Cheptebo licence royalty pending",
        subheadline: "Cheptebo Cooperative adopted the technique in Feb 2024. Royalty due within 90 days of their season settlement.",
        status: "Watching", confidence: "Medium",
        trigger: "Cheptebo NCE settlement + 90-day licence window",
        resolver: "Cheptebo Cooperative Society",
        expected_resolution: "90 days", evidence_count: 1,
        confirmations: [
          { name: "Cheptebo Cooperative Society", org: "Licensee", status: "Pending" },
        ],
        proofPack: {
          why_recorded: "Cheptebo Cooperative executed a derivative licence in Feb 2024. Settlement follows their own season's NCE result.",
          evidence_items: ["Derivative licence record linked to origin IP asset hash"],
          verifier: "Cheptebo Cooperative Society",
          source: "Derivative Licence Agreement",
          confidence_level: "Medium",
          last_verified_date: "Feb 2024",
          status: "Awaiting verification",
        },
      },
    ],
    banner: {
      text: "Demo · Aisha Ng'etich · Kaptumo Cooperative · Nandi County, Kenya",
      mobileText: "Demo · Aisha Ng'etich",
      bg: "rgba(92,122,58,0.08)",
      border: "rgba(92,122,58,0.2)",
    },
    valueMix: { settled: 186000, pending: 76000, future: 5000, currency: "KES", label: "Total tracked" },
    bars: [
      { label: "2022 delivery", value: 58000, status: "settled", evidence_count: 1 },
      { label: "2023 delivery", value: 68000, status: "settled", evidence_count: 1 },
      { label: "Kabitet licence", value: 14200, status: "settled", evidence_count: 2 },
      { label: "2024 delivery", value: 62000, status: "pending", evidence_count: 2 },
      { label: "Cheptebo licence", value: 13800, status: "pending", evidence_count: 1 },
    ],
    quickRead: [
      { question: "What has been received?", answer: "Three seasons of AA-grade delivery premiums plus one settled derivative licence royalty", value: "KSh186K", valueColor: "green" },
      { question: "What is next to move?", answer: "Season 2024 NCE trigger fired at KES 142.40/kg — awaiting cooperative M-PESA transfer", value: "KSh62K", valueColor: "amber" },
      { question: "Where is the upside?", answer: "A third cooperative has enquired about licensing the fermentation technique — not yet executed", value: "KSh5K", valueColor: "blue" },
    ],
    milestones: [
      { status: "ok", title: "First delivery · Kaptumo wet mill · AA grade", meta: "QR scan · sha256: 2c8b5f… · 2,210 kg · Mar 2022", amount: "+KSh58,000", amountColor: "green" },
      { status: "info", title: "IP Asset registered · Anaerobic fermentation technique", meta: "sha256: 9b4e2a… · anchored 2022", amount: null },
      { status: "ok", title: "Kabitet Cooperative · derivative licence executed", meta: "sha256: 4f7a1c… linked to origin · Apr 2023", amount: "+KSh14,200", amountColor: "green" },
      { status: "ok", title: "Season 2023 delivery settled · NCE KES 138.20/kg", meta: "M-PESA confirmed · 2,440 kg AA", amount: "+KSh68,000", amountColor: "green" },
      { status: "info", title: "Cheptebo Cooperative · second derivative licence", meta: "sha256: 8c2e5b… linked to origin · Feb 2024", amount: "KSh13,800", amountColor: "amber" },
      { status: "watch", title: "Season 2024 · NCE trigger fired · awaiting M-PESA", meta: "KES 142.40/kg · Week 18 · cooperative transfer pending", amount: "KSh62,000", amountColor: "amber" },
    ],
    bio:
      "Aisha has delivered AA-grade cherry to Kaptumo Cooperative for three consecutive seasons. Her anaerobic fermentation technique — developed on her 1.4-hectare holding — produces the flavour profile that commands Nandi County's premium above the NCE floor price. Two neighbouring cooperatives have since adopted the technique under licence. Without SCORE, the technique has no verifiable record and no financial claim; with it, every delivery, auction result, and licence event is timestamped, fingerprinted, and portable.",
    badges: ["3 seasons · consistent AA", "NCE trigger · public · independent", "2 derivative licences", "Verifiable borrower"],
    contribution: [
      "Delivered AA-grade coffee cherry to Kaptumo Cooperative for 3 consecutive seasons",
      "Developed an anaerobic fermentation technique that commands a market premium",
      "Licensed the technique to 2 neighbouring cooperatives, generating derivative royalties",
      "Built a 3-season delivery + settlement record usable as an independent credit signal",
    ],
    valueStreams: [
      {
        icon: "leaf",
        iconColor: "#5C7A3A",
        name: "Delivery premium share",
        description: "Share of cooperative premium pool above the NCE floor price, paid per season by delivery weight × quality grade.",
        value: "KSh186K paid",
      },
      {
        icon: "droplets",
        iconColor: "#2A5C8A",
        name: "Fermentation technique",
        description: "Anaerobic fermentation method developed on Aisha's holding — the source IP asset behind both derivative licences.",
        value: "1 IP asset anchored",
      },
      {
        icon: "git-fork",
        iconColor: "#7A5C2A",
        name: "Derivative licence royalties",
        description: "Royalty share when neighbouring cooperatives adopt the technique under licence — decays faster than the direct delivery stake.",
        value: "KSh28K settled+pending",
      },
    ],
    evidenceMappings: [
      {
        evidence: {
          type: "Auction result",
          title: "NCE public auction · Week 18 2024",
          source: "Nairobi Coffee Exchange · nce.co.ke",
          period: "Week 18 · May 2024",
          fingerprint: "NCE-W18-2024 · KES 142.40/kg",
          metric: "KES 142.40/kg · AA grade",
        },
        ledger: {
          bucket: "Pending",
          entry: "Season 2024 premium settlement",
          amount: 62000,
          currency: "KES",
          contract: "Kaptumo Cooperative Premium Pool · Season 2024",
        },
        rule: "(NCE price − floor) × delivery kg × quality grade factor × 8% pool stake",
        status: "Awaiting sign-off",
      },
      {
        evidence: {
          type: "Delivery record",
          title: "QR-scanned delivery · Lot KMT-2024-007",
          source: "Kaptumo wet mill · QR scan at intake",
          period: "14 Mar 2024",
          fingerprint: "sha256: a3f2c9d1… · RFC 3161",
          metric: "2,780 kg · 100% ripe cherry · AA grade",
        },
        ledger: {
          bucket: "Pending",
          entry: "Season 2024 premium settlement",
        ...
        rule: "Weight + quality grade determine Aisha's proportional share of the lot",
        status: "Reconciled",
      },
      {
        evidence: {
          type: "Licence execution",
          title: "Derivative licence · Kabitet Cooperative",
          source: "Licence agreement · linked to origin IP hash",
          period: "14 Apr 2023",
          fingerprint: "sha256: 4f7a1c… linked to 9b4e2a1c…",
          metric: "3% of Kabitet premium pool",
        },
        ledger: {
          bucket: "Paid",
          entry: "Kabitet licence royalty · Season 2023",
          amount: 14200,
          currency: "KES",
          contract: "Anaerobic Fermentation Technique · Derivative Licence Agreement",
        },
        rule: "3% of adopter's premium pool above NCE floor, 20%/yr decay, KES 5,000 cap",
        status: "Reconciled",
      },
    ],
  },
