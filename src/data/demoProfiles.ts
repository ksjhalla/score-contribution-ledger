...
export const pppNotifications: DemoNotification[] = [
  {
    ...
    type: "settlement_due",
    message:
      "Q1 2026 tariff revenue distribution ready. Audited kWh + collection report received. Mark as settled when concession transfer confirmed.",
    read: false,
  ...
  },
  {
    ...
    type: "trigger_met",
    message:
      "Uptime performance bonus triggered — 99.2% grid availability for 2025. Log an execution against the Concession Performance Agreement.",
    read: true,
...
export const demoProfiles: Record<DemoKey, DemoProfile> = {
  ...
  ppp: {
    ...
    contributor: {
      name: "Kwame Asante",
      role: "Project Director · Volta Region Mini-Grid Programme",
      org: "Sunlite Power Ghana Ltd · Private Developer",
      id: "SCR-KA-2022-007",
      sector: "Other",
    },
    ...
    whatChanged: [
      {
        ...
        headline: "paid",
        subheadline: "Q4 2025 tariff revenue distributed. Audited kWh + collection report confirmed by trustee.",
        status: "Resolved", confidence: "High",
      ...
      },
      {
        amount: 720000, currency: "USD",
        headline: "on the way",
        subheadline: "Grid uptime hit 99.2% for 2025 across 12 sites — performance bonus triggered, awaiting audit sign-off.",
        status: "Under review", confidence: "High",
      ...
      },
      {
        ...
        headline: "could grow",
        subheadline: "Phase 2 — 18 additional villages — under Ministry review with GIZ co-financing. First-refusal build rights apply.",
        status: "Watching", confidence: "Medium",
        trigger: "Ministry approves Phase 2 + GIZ finance close",
        resolver: "Ministry of Energy + GIZ",
    ...
    quickRead: [
      { question: "What is already paid?", answer: "Three audited quarterly tariff distributions plus 2024 annual reconciliation", value: "$2.84M", valueColor: "green" },
      { question: "What is next to move?", answer: "2025 uptime bonus — 99.2% grid availability achieved, audit sign-off in 45 days", value: "$720K", valueColor: "amber" },
    ...
    milestones: [
      { status: "ok", title: "Q4 2025 tariff revenue distributed", meta: "Audited kWh + collection report · Jan 2026", amount: "+$720,000", amountColor: "green" },
      { status: "ok", title: "Q3 2025 tariff revenue distributed", meta: "Audited kWh + collection report · Oct 2025", amount: "+$680,000", amountColor: "green" },
      { status: "ok", title: "2024 annual concession reconciliation", meta: "External auditor · Feb 2025", amount: "+$1,440,000", amountColor: "green" },
      { status: "watch", title: "Uptime bonus pending · 99.2% achieved", meta: "Technical audit · 45 days", amount: "$720,000 pending", amountColor: "amber" },
    ...
    bio:
      "Kwame leads Sunlite Power Ghana's stake in a 12-village solar mini-grid programme in the Volta Region — a 20-year concession built jointly with the Energy Commission of Ghana, a local operating partner, and a smart-metering technology provider. Sunlite provided the capital and built the systems; the government provided land, permits, and tariff policy; the operator runs day-to-day uptime and customer service; the tech partner runs metering and mobile-money collection. Revenue flows from households and small businesses paying for electricity, audited quarterly, and split across all four contributors. SCORE shows Kwame — at a glance — what Sunlite has been paid, what is on the way, and what could grow if Phase 2 (18 more villages) is approved.",
    ...
    valueStreams: [
      {
        ...
        iconColor: "#7A5C2A",
        name: "Tariff Revenue",
        description: "Quarterly share of audited kWh sales + mobile-money collections across 12 village sites",
        value: "$2.84M paid",
      },
      {
        icon: "leaf",
        ...
        description: "Uptime-linked bonus when independent audit confirms ≥ 99.0% grid availability",
        value: "$720K pending",
      },
      {
        icon: "git-fork",
